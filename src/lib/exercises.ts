...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    reps: '10-12',
    muscle_emoji: '🍑',
    tips_ru: '🔑 Самая крупная мышца тела — максимальный гормональный ответ. Таз поднимай до параллели с полом, задержи 1 сек на пике. Стопы на ширине плеч, подбородок прижат к груди. Защищает поясницу и колени.',
    gifUrl: 'https://static.exercisedb.dev/media/Zg3XY7P.gif',
    instagramUrl: 'https://www.instagram.com/reel/DWEuqFXiBrk/',
