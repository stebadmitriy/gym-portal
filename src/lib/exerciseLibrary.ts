...
export const EXERCISE_LIBRARY: LibraryExercise[] = [
  ...
  // ===================== TRAPS =====================
  {
    ...
    tips_ru: 'Поднимай плечи строго вверх — не вперёд и не по кругу. Держи шею нейтральной. Медленное опускание с паузой наверху максимизирует стимул для роста. Из видео: при стойке вертикально нагрузка уходит в шею — небольшой наклон вперёд с тягой плеч вверх и назад переносит акцент на верхние и средние трапеции. Это снижает давление на шейный отдел и активирует больше мышечных волокон.'
  },
  ...
  // ===================== CHEST =====================
  {
    ...
    tips_ru: 'Своди руки в конечной точке, думая о сжатии груди, а не о подъёме веса. Лопатки прижаты к спинке. Контролируй эксцентрик 3-4 секунды. Из видео: сведи лопатки, упри ступни в пол и создай устойчивый прогиб — это защищает плечи и генерирует больше силы. Локти слегка подогнуты, опускай штангу подконтрольно и дожимай через середину стопы и грудь.'
  },
  {
    id: 'incline_pec_fly',
    ...
    tips_ru: 'Слегка согнутые локти на протяжении всего движения. Растяни грудь в нижней точке — именно там происходит максимальный механический стресс. Не соединяй руки слишком сильно вверху. Из видео: сохраняй лёгкий наклон вперёд, веди руки широкой дугой до полного сокращения груди. Контролируй растяжку, делай паузу в точке максимального натяжения — именно это активирует большинство волокон. Из видео: угол 45° — оптимальный для жима, он даёт лучшую активацию груди и снижает нагрузку на плечо; при 90° — лишний стресс на сустав, при 20° — акцент уходит на трицепс.'
  },
  {
    id: 'cable_chest_fly',
  ...
  // ===================== LEGS QUADS =====================
  {
    ...
    tips_ru: 'Ставь ступни выше для акцента на ягодичные, ниже — на квадрицепсы. Колени не своди внутрь. Безопаснее становой тяги при проблемах со спиной. Из видео: высокое положение ног акцентирует ягодичные и бицепс бедра; низкое — квадрицепсы; широкая постановка — приводящие; узкая — квадрицепсы. Полная амплитуда, контроль темпа, не блокируй колени.'
  },
  {
    id: 'leg_extension',
    ...
    tips_ru: 'Полная амплитуда с задержкой 1-2 сек наверху. Носки можно направить внутрь для акцента на внешнюю головку. Исследования показывают, что разгибание ног безопасно для здоровых коленей. Из видео: небольшие изменения угла и положения корпуса переключают нагрузку между квадрицепсами, бицепсом бедра, ягодичными и икрами. Медленный эксцентрик и вариации с наклоном назад включают заднюю поверхность — тренажёр даёт больше, чем кажется.'
  },
  {
    id: 'barbell_squat',
  ...
  // ===================== GLUTES =====================
  {
    ...
    tips_ru: 'Сожми ягодицы в верхней точке с полным разгибанием бедра. Не переразгибай поясницу — движение должно быть в тазу. Исследования @brettcontreras показывают, что это упражнение №1 для ягодичных. Из видео: для полноценного развития ягодичных нужно прорабатывать их со всех углов — hip thrust для силы и пикового сокращения, RDL для растяжки, выпады для глубины и одностороннего контроля.'
  },
  {
    ...
    tips_ru: 'Передняя нога дальше — больше ягодичных, ближе — больше квадрицепсов. Опускайся до касания коленом пола. Одно из лучших упражнений для асимметрии и ягодичных. Из видео: лёгкий наклон корпуса вперёд — более глубокое сгибание в тазобедренном суставе и более сильная активация ягодичных. Вертикальный корпус — нагрузка смещается на квадрицепсы. Освой оба варианта для сбалансированного развития ног.'
  },
  {
  ...
  // ===================== TRICEPS =====================
  {
    ...
    tips_ru: 'Локти зафиксированы у тела. Полное разгибание с 1 сек паузой внизу. V-гриф даёт нейтральный хват и снижает нагрузку на запястья. Трицепс = 2/3 объёма руки. Из видео: держи локти плотно у боков от начала до конца, не отводи их — это одно из самых эффективных изолирующих упражнений для трицепса при правильной технике. Избегай раскачки, наклонов и читинга — они снимают нагрузку с мышцы.'
  },
  {
    id: 'skull_crushers',
  ...
  },
  {
    ...
    tips_ru: 'Разгибание над головой растягивает длинную головку трицепса — это максимизирует гипертрофию. Держи локти неподвижно. Кабельная версия сохраняет натяжение в растянутом положении. Из видео: в Cable Triceps Extension плечи зафиксированы — нагрузка только на трицепс. Отличие от Straight-Arm Pulldown: там локти слегка согнуты и стабильны, а работают широчайшие — схожие движения тренируют абсолютно разные мышцы.'
  },
  {
    id: 'triceps_kickback',
